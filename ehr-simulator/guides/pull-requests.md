...
2. Ensure your PR addresses only one concern.
    * Keep PRs small! Try to keep *non-autogenerated* lines of code under 500.
...
Assign at least one reviewer. **Reviews are now required on all PRs before they can be merged!**
...
Try not to pick the same person every time. It's good to get different perspectives. If you are modifying a feature, a good idea might be to assign the person who originally created the feature as a reviewer. Or you could rotate through the team.
...
5. Is the code readable and easy to understand? Will a teammate understand the code in six months? Is any of the code duplicated, overly complex, or generally smelly?
...
**Linear**
Once the PR is approved, move it to the "Done" column to be merged.
