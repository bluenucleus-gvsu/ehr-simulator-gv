...
/*
  Not currently used in the EHR. Once EHR supports Multi-Patient Simulation, this
  component can be added to the tabbed EHR navigation so students can access
          ...
          <div className="flex flex-col justify-start items-center">
            <DialogClose asChild>
              <button
                ...
                aria-label={`Open chart for ---`}
              >
                <div className="w-full flex justify-between items-start gap-2">
                  <p className="text-lg font-semibold underline-offset-2 group-hover:underline">---</p>
                </div>
                <div className="flex pl-2">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex flex-col">
                      ...
                      <p className="text-sm pt-0.5 pl-2">---</p>
                    </div>
                    <div className="flex flex-col">
                      <Label className="text-xs">Code Status</Label>
                      <p className="w-full text-sm pt-0.5 pl-2">
                        <span className="bg-yellow-200 px-3 py-0.5 rounded-xl">---</span>
                      </p>
                    </div>
                    <div className="flex flex-col">
